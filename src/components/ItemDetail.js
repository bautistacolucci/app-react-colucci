    ...
    return(
        <div className='w-6/12 mx-auto mt-8 p-5 border-gray-200 border rounded'>
            ...
            <div> 
            {
                added ? 
                <Link to='/cart' >
                    <button className='flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 py-3 px-8 text-base font-medium text-white hover:bg-indigo-700'>Ir al carrito</button>
                </Link>
                :
